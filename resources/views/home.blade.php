...
<body>
  ...
  <section id="hero" class="wow fadeIn">
      <div class="hero-container">
          <hr>
            <h1>Welcome to Bamboozled</h1>
            <h2>Find top notch content and &amp; more...</h2>
      <img src="images/vector3-01.png" alt="Hero Imgs" height="522" width="1292">
  ...
  <section id="get-started" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <h2>The Spiciest </h2>
        <p class="separator">Worlds finest comics .</p>
  ...
  <section id="features" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <p class="separator">Start something new! .</p>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="feature-block">
            <img src="images/15.jpg" alt="img" class="img-fluid">
            <h4>Title</h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="feature-block">
            <img src="images/28.jpg" alt="img" class="img-fluid">
            <h4>Title</h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="feature-block">
            <img src="images/29.jpg" alt="img" class="img-fluid">
            <h4>Title</h4>
        ...
        <div class="col-md-6 col-lg-3">
                <div class="feature-block">
                  <img src="images/12.jpg" alt="img" class="img-fluid">
                  <h4>Title</h4>
  ...
  <section id="screenshots" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
      <div class="owl-carousel owl-theme">
        ...
        <div><img src="images/32.jpg" alt="img"></div>
        <div><img src="images/23.jpg" alt="img"></div>
        <div><img src="images/26.jpg" alt="img"></div>
        <div><img src="images/31.jpg" alt="img"></div>
        <div><img src="images/16.jpg" alt="img"></div>
        <div><img src="images/11.jpg" alt="img"></div>
        <div><img src="images/5.jpg" alt="img"></div>
              ...
              <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item  active">
                  <div class="top-top">
                    ...
                    <p> I believe in life. I believe. I...fight. I bleed. For others. To keep them...alive. I live...I live, so others will live. I believe.</p>
                    <h4>Laura Kinney<span>Earth-616</span></h4>
                ...
                <div class="carousel-item ">
                  ...
                  <h2>Quotes of the week</h2>
                    <p>Luck and I haven't been all that close lately. Try again. </p>
                    <h4>Kara Zor-El<span>New Earth</span></h4>
                ...
                <div class="carousel-item ">
                  <div class="top-top">
                        ...
                        <h2>Quotes of the week</h2>
                    <p> I have no powers and not nearly enough training, but I'm doing this anyways. Being a super hero is amazing. Everyone should try it.</p>
                    <h4>Kate Bishop<span>Earth-616</span></h4>
